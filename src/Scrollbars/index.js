 ...
 * onScrollFrame?(...args: unknown[]): unknown;
 * onScrollStart?(...args: unknown[]): unknown;
 * onScrollStop?(...args: unknown[]): unknown;
 * onUpdate?(...args: unknown[]): unknown;
 * renderView?(...args: unknown[]): unknown;
 * renderTrackHorizontal?(...args: unknown[]): unknown;
 * renderTrackVertical?(...args: unknown[]): unknown;
 * renderThumbHorizontal?(...args: unknown[]): unknown;
 * renderThumbVertical?(...args: unknown[]): unknown;
 * tagName?: string;
 * thumbSize?: number;
 * thumbMinSize?: number;
